...
MAVEN_BUILD_IMAGE=${MAVEN_BUILD_IMAGE:-${SUPP_DOCKER_REPO}maven:3.9-openjdk-17-slim}
...
NPM_JRE_IMANGE=${NPM_JRE_IMANGE:-${SUPP_DOCKER_REPO}openjdk:17-jre-slim}
...
CERTS_IMAGE=${CERTS_IMAGE:-${SUPP_DOCKER_REPO}openjdk:17-jre-slim}
